$(document).ready(function () {
    ...
    /* add/edit order validation */
    $(document)
    .find("#order_update_form")
    .validate({
        rules: {
            name: {
                required: true,
        ...
        submitHandler: function (form) {
            var postData = $("#order_update_form").serializeArray();
            update_order_details("order_update_form", postData);
        },
    });

        $(document)
        .find("#blog-category-form")
        .validate({
            rules: {
                name: {
                    required: true,
            ...
            submitHandler: function (form) {
                var postData = $("#blog-category-form").serializeArray();
                add_update_details("blog-category-form", postData);
            },
        });
