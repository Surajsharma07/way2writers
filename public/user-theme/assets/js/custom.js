    ...
    var MarktifyAppX = {
        ...
        Isotop_gallery: function () {
            $(window).on("load", function () {
                ...
                // Delay the click event to ensure it happens after the page has loaded
                setTimeout(function () {
                    $(".int_project_gallery > .gallery_nav > ul > li:first-child a").click();
                }, 100);
...
function filterProductsByCategory(categoryId) {
    ...
    products.forEach(function(product) {
        var productCategoryId = product.classList[1].split('-')[1];

        if (categoryId === '' || categoryId == productCategoryId) {
...
$(".faq-ques").find("dd:first").show();
	$(".faq-ques").find("dt:first").addClass("active");
	$(".faq-ques").find("dt").click(function(){
		if(!$(this).hasClass("active")){
			$(".faq-ques").find("dt").removeClass("active")
			$(".faq-ques").find("dd").slideUp();
