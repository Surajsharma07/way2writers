...
class ServicesController extends Controller
{
    ...
    $data['featured_category'] = ProductSubCategory::where(['category_id'=>2,'is_active'=>1])->get();
    $deliveryoptions = DeliveryOptions::all();
    $data['deliveryoptions'] = $deliveryoptions;
    $data['products'] = Product::where(['category_id'=>2,'is_active'=>1])->inRandomOrder()->take(12)->get();
    ...
    $data['featured_products'] = Product::where(['is_featured'=>1,'is_active'=>1])->inRandomOrder()->take(6)->get();
       ...
       $obj = ProductAnalysis::firstOrNew(['ip_adress'=> request_ip()]);
        ...
        $obj->save();
        return  response(view('frontend.services.single_details',$data));
    }
    public function search()
    {
        ...
        return view('frontend.services.search',$data);
    }
    /**
    ...
    public function ajax_search_product(Request $request){
        ...
        $html= view('frontend.services.services_search', ['data' =>$data,'p_view'=>@$request->p_view])->render();
