...
class DeliveryOptionsController extends Controller
    {
        ...
        {
            $data['data']= DeliveryOptions::orderBy('id','DESC')->paginate(10);
            return view('admin.product.delivery_options',$data);
        }
        ...
        public function store(Request $request)
        {
            ...
            $obj = DeliveryOptions::firstOrNew(['id'=>$request->category_id]);
