...
<a href="<?php echo e(app('router')->has('frontend.home') ? route('frontend.home') : url('/')); ?>" class="tp-404-btn">
...
<?php /**PATH C:\xampp\htdocs\way2\resources\views/errors/illustrated-layout.blade.php ENDPATH**/ ?>