            ...
            <ul>
                <?php if(@$setting->is_check_home): ?>
                    <li <?php if(Route::is('frontend.home')): ?> class="active" <?php endif; ?>>
                        <a href="<?php echo e(route('frontend.home')); ?>" style="
    color: black;
">
                ...
                <?php if(@$setting->is_check_about): ?>
                    <li <?php if(Route::is('frontend.about-us')): ?> class="active" <?php endif; ?>><a
                            href="<?php echo e(route('frontend.about-us')); ?>" style="
    color: black;
"> <?php echo app('translator')->get('master.header.About_Us'); ?></a>
                    </li>
                <?php endif; ?>
              ...
              <?php if(@$setting->is_check_product): ?>
                    <li style="
    color: black;
" <?php if(Route::is('frontend.product.search')): ?> class="active" <?php endif; ?>>
     ...
     <?php if(@$setting->is_check_terms_and_condition): ?>
                ...
                <?php if(@$setting->is_check_contact): ?>
                    <li <?php if(Route::is('frontend.contact-us')): ?> class="active" <?php endif; ?>>
                        <a style="
    color: black;
" href="<?php echo e(route('frontend.contact-us')); ?>"><?php echo app('translator')->get('master.header.Contact_Us'); ?></a>
                    </li>
                <?php endif; ?>
<li <?php if(Route::is('frontend.blogs.index')): ?> class="active" <?php endif; ?>>
                        <a style="
    color: black;" href="<?php echo e(route('frontend.blogs.index')); ?>">Blogs</a>
                    </li>
...
<?php /**PATH C:\xampp\htdocs\way2\resources\views/frontend/layout/nav2.blade.php ENDPATH**/ ?>