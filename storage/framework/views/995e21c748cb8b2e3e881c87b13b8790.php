...
<?php $__env->startSection('content'); ?>
    ...
    <div>
    <div style="height: 300px; background-image: url('<?php echo e($ASSET_URL); ?>assets/images/my_images/images/contact-banner.jpg'); background-position: center;">
    ...
    <div class="tp_banner_section tp_single_section">
        <div class="container">
            <div class="tp_banner_heading">
                <h2 style="
    margin: 15px 0 10px;
"><?php echo app('translator')->get('master.header.Contact_Us'); ?></h2>
                <p>
                    <?php echo app('translator')->get('master.contact_us.heading'); ?>
                </p>
            </div>
        </div>
    </div>
...
">Contact Information</h2>             
                        ...
                        <div class="tp_contact_detail">
                            <p><?php echo app('translator')->get('master.contact_us.email_address'); ?></p>
                            <span><?php echo e(@$setting->company_email); ?></span>
                        ...
                        <div class="tp_contact_detail">
                            <p><?php echo app('translator')->get('master.contact_us.number'); ?></p>
                ...
                <div class="col-xl-8 col-lg-8 col-md-7 align-self-center">
                    <div class="tp_leave_section">
                        <div class="tp_reply_form">
                            <h4><?php echo app('translator')->get('master.contact_us.here_to_help'); ?></h4>
<form id="update_user_details" action="<?php echo e(route('frontend.post-contact-us')); ?>" method="POST"  enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                          <div class="row">
                                    <div class="col-lg-6">
                                        <div class="tp_input_box">
                                            <label><?php echo app('translator')->get('master.contact_us.name'); ?>*</label>
                                            <div class="tp_input">
                              ...
                              <div class="col-lg-6">
                                        <div class="tp_input_box">
                                            <label><?php echo app('translator')->get('master.contact_us.email'); ?>*</label>
                                            <div class="tp_input">
                             ...
                             <div class="col-lg-6">
                                        <div class="tp_input_box">
                                            <label><?php echo app('translator')->get('Mobile No. *'); ?></label>
                                            <div class="tp_input">
                             ...
                             <div class="col-lg-12">
                                        <div class="tp_input_box">
                                            <label><?php echo app('translator')->get('master.contact_us.message'); ?></label>
                                            <div class="tp_input">
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\way2\resources\views/frontend/footer-pages/contact-us.blade.php ENDPATH**/ ?>