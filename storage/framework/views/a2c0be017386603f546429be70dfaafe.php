        ...
        <div class="position">
          <div class="make1">
            <div class="clearfix">
                ...
                <a class="nav-link " href="<?php echo e(route('frontend.contact-us')); ?>"><span class="know-more">Free Resume Analysis</span></a>
            </div>
          </div>
        </div>				
    </article>
...
<div class="contactnow d-none d-md-block">
    ...
    <ul>
        <li><a href="tel:9599889860"><img src="<?php echo e($ASSET_URL); ?>assets/images/my_images/images/spacer.gif" class="ico cus-icon cus-call" /> <strong>+91-95998 89860</strong></a></li>
        <li><a href="<?php echo e(route('frontend.contact-us')); ?>"><img src="<?php echo e($ASSET_URL); ?>assets/images/my_images/images/spacer.gif" class="ico cus-icon cus-call-requ" /> REQUEST A CALLBACK</a></li>
    </ul>
</div>
...
<div class="gray-left-skew"></div>
           ...
           <?php /**PATH C:\xampp\htdocs\way2\resources\views/frontend/layout/header.blade.php ENDPATH**/ ?>