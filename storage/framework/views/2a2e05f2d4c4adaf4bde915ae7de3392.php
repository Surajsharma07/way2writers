...
<?php $__env->startSection('head_scripts'); ?>
    <title><?php echo app('translator')->get('page_title.Admin.setting_title'); ?></title>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="setting-tab-tar active" id="seo-setting">
                        <form id="seo-form" action="<?php echo e(route('admin.setting.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                                    ...
                                    <div class="col-lg-4 col-md-12">
                                        <div class="tp_form_wrapper">
                                            ...
                                            <input class="form-control" type="text" placeholder="Enter Site Name"
                                                name="site_name" value="<?php echo e(@$data->site_name); ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-12">
                                        <div class="tp_form_wrapper">
                                            ...
                                            <input class="form-control" type="text" placeholder="Enter Site Title"
                                                name="site_title" value="<?php echo e(@$data->site_title); ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-12">
                                        <div class="tp_form_wrapper">
                                            ...
                                            <input class="form-control" type="text" placeholder="Enter Site Author"
                                                name="site_author" value="<?php echo e(@$data->site_author); ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12">
                                        <div class="tp_form_wrapper">
                                            ...
                                            <textarea class="form-control form-textarea" rows="5" cols="50" spellcheck="true"
                                                placeholder="Enter Meta Keywords" name="site_meta_keywords"><?php echo e(@$data->site_meta_keywords); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12">
                                        <div class="tp_form_wrapper">
                                            ...
                                            <textarea class="form-control form-textarea" rows="5" cols="50" spellcheck="true"
                                                placeholder="Enter Meta Description" name="site_meta_desc"><?php echo e(@$data->site_meta_desc); ?></textarea>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="setting-tab-tar" id="site-images-setting">
                        <div class="tp_catset_box_wrapper">
                            <form id="site-images-form" action="<?php echo e(route('admin.setting.store')); ?>" method="POST"
                                                    ...
                                                    <div class="tp_upload_area">
                                                        <div class="tp_pic_wrapper tp_img_div pre_loader_img">
                                                            <img class="tp_upload_pic"
                                                                src="<?php echo e($STORAGE_URL . @$data->pre_loader_img); ?>"
                                                                alt="pre-loader-img">
                                                        </div>
                                                        <div class="tp_upload_pic_thumb">
                                                            <label class="upload_button">
                                                                ...
                                                                <input type="hidden" name="pre_loader_img"
                                                                    value="<?php echo e(@$data->pre_loader_img); ?>">
                                                ...
                                                <div class="tp_uploade_images_main">
                                                    <div class="tp_upload_area">
                                                        <div class="tp_pic_wrapper tp_img_div favicon_img">
                                                            <img class="tp_upload_pic"
                                                                src="<?php echo e($STORAGE_URL . @$data->favicon_img); ?>"
                                                                alt="favicon-img">
                                                        </div>
                                                        <div class="tp_upload_pic_thumb">
                                                            <label class="upload_button">
                                                                ...
                                                                <input type="hidden" name="favicon_img"
                                                                    value="<?php echo e(@$data->favicon_img); ?>">
                                                ...
                                                <div class="tp_uploade_images_main">
                                                    <div class="tp_upload_area">
                                                        <div class="tp_pic_wrapper tp_img_div my_logo">
                                                            <img class="tp_upload_pic"
                                                                src="<?php echo e($STORAGE_URL . @$data->my_logo); ?>"
                                                ...
                                                <div class="tp_uploade_images_main">
                                                    <div class="tp_upload_area">
                                                        <div class="tp_pic_wrapper tp_img_div white_logo">
                                                            <img class="tp_upload_pic"
                                                                src="<?php echo e($STORAGE_URL . @$data->white_logo); ?>"
                                                        ...
                                                        <div class="tp_upload_pic_thumb">
                                                            <label class="upload_button">
                                                                ...
                                                                <input type="hidden" name="white_logo"
                                                                    value="<?php echo e(@$data->white_logo); ?>">
                                                ...
                                                <div class="tp_uploade_images_main">
                                                    <div class="tp_upload_area">
                                                        <div class="tp_pic_wrapper tp_img_div not_found_img">
                                                            <img class="tp_upload_pic"
                                                                src="<?php echo e($STORAGE_URL . @$data->not_found_img); ?>"
                                                                alt="404-img">
                                                        </div>
                                                        <div class="tp_upload_pic_thumb">
                                                            <label class="upload_button">
                                                                ...
                                                                <input type="hidden" name="not_found_img"
                                                                    value="<?php echo e(@$data->not_found_img); ?>">
                                                ...
                                                <div class="tp_uploade_images_main">
                                                    <div class="tp_upload_area">
                                                        <div class="tp_pic_wrapper tp_img_div error_icon_img">
                                                            <img class="tp_upload_pic"
                                                                src="<?php echo e($STORAGE_URL . @$data->error_icon_img); ?>"
                                                                alt="OOPs-img">
                                                        </div>
                                                        <div class="tp_upload_pic_thumb">
                                                            <label class="upload_button">
                                                                ...
                                                                <input type="hidden" name="error_icon_img"
                                                                    value="<?php echo e(@$data->error_icon_img); ?>">
                                                ...
                                                <div class="tp_uploade_images_main">
                                                    <div class="tp_upload_area">
                                                        <div class="tp_pic_wrapper tp_img_div success_icon_img">
                                                            <img class="tp_upload_pic"
                                                                src="<?php echo e($STORAGE_URL . @$data->success_icon_img); ?>"
                                                                alt="sucess-img">
                                                        </div>
                                                        <div class="tp_upload_pic_thumb">
                                                            <label class="upload_button">
                                                                ...
                                                                <input type="hidden" name="success_icon_img"
                                                                    value="<?php echo e(@$data->success_icon_img); ?>">
                                                ...
                                                <div class="tp_uploade_images_main">
                                                    <div class="tp_upload_area">
                                                        <div class="tp_pic_wrapper tp_img_div preview_image">
                                                            <img class="tp_upload_pic"
                                                                src="<?php echo e($STORAGE_URL . @$data->preview_image); ?>"
                                                        ...
                                                        <div class="tp_upload_pic_thumb">
                                                            <label class="upload_button">
                                                                ...
                                                                <input type="hidden" name="preview_image"
                                                                    value="<?php echo e(@$data->preview_image); ?>">
                                                ...
                                                <div class="tp_uploade_images_main">
                                                    <div class="tp_upload_area">
                                                        <div class="tp_pic_wrapper tp_img_div default_user_image">
                                                            <img class="tp_upload_pic"
                                                                src="<?php echo e($STORAGE_URL . @$data->default_user_image); ?>"
                                                        ...
                                                        <div class="tp_upload_pic_thumb">
                                                            <label class="upload_button">
                                                                ...
                                                                <input type="hidden" name="default_user_image"
                                                                    value="<?php echo e(@$data->default_user_image); ?>">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="setting-tab-tar" id="home-images-setting">
                        <div class="tp_catset_box_wrapper">
                            <form id="home-images-form" action="<?php echo e(route('admin.setting.store')); ?>" method="POST"
                                enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="tp_catset_box tp_set_site">
                                    <div class="alert alert-info">
                                                ...
                                                <div class="tp_uploade_images_main">
                                                    <div class="tp_upload_area">
                                                        <div class="tp_pic_wrapper tp_img_div home_page_bg_img">
                                                            <img class="tp_upload_pic"
                                                                src="<?php echo e($STORAGE_URL . @$data->home_page_bg_img); ?>"
                                                                alt="homepage-bg-img">
                                                        </div>
                                                        <div class="tp_upload_pic_thumb">
                                                            <label class="upload_button">
                                                                ...
                                                                <input type="hidden" name="home_page_bg_img"
                                                                    value="<?php echo e(@$data->home_page_bg_img); ?>">
                                            ...
                                            <div class="checkbox mb-3">
                                                <label>
                                                    ...
                                                    <input class="form-control" type="checkbox"
                                                        ...
                                                        <?php if(@$data->is_checked_show_all_anim_img == 1): ?> checked <?php endif; ?> value="1"><i
                                                ...
                                                <div class="tp_uploade_images_main">
                                                    <div class="tp_upload_area">
                                                        <div class="tp_pic_wrapper tp_img_div home_page_bg_animation_img">
                                                            <img class="tp_upload_pic"
                                                                src="<?php echo e($STORAGE_URL . @$data->home_page_bg_animation_img); ?>"
                                                        ...
                                                        <div class="tp_upload_pic_thumb">
                                                            <label class="upload_button">
                                                                ...
                                                                <input type="hidden" name="home_page_bg_animation_img"
                                                                    value="<?php echo e(@$data->home_page_bg_animation_img); ?>">
                                                ...
                                                <div class="tp_uploade_images_main">
                                                    <div class="tp_upload_area">
                                                        <div class="tp_pic_wrapper tp_img_div home_middle_banner">
                                                            <img class="tp_upload_pic"
                                                                src="<?php echo e($STORAGE_URL . @$data->home_middle_banner); ?>"
                                                        ...
                                                        <div class="tp_upload_pic_thumb">
                                                            <label class="upload_button">
                                                                ...
                                                                <input type="hidden" name="home_middle_banner"
                                                                    value="<?php echo e(@$data->home_middle_banner); ?>">
                                                ...
                                                <div class="tp_uploade_images_main">
                                                    <div class="tp_upload_area">
                                                        <div class="tp_pic_wrapper tp_img_div tp_img_div home_bg_s_img1">
                                                            <img class="tp_upload_pic"
                                                                src="<?php echo e($STORAGE_URL . @$data->home_bg_s_img1); ?>"
                                                                alt="image1-img">
                                                        </div>
                                                        <div class="tp_upload_pic_thumb">
                                                            <label class="upload_button">
                                                                ...
                                                                <input type="hidden" name="home_bg_s_img1"
                                                                    value="<?php echo e(@$data->home_bg_s_img1); ?>">
                                                ...
                                                <div class="tp_uploade_images_main">
                                                    <div class="tp_upload_area">
                                                        <div class="tp_pic_wrapper tp_img_div tp_img_div home_bg_s_img2">
                                                            <img class="tp_upload_pic"
                                                                src="<?php echo e($STORAGE_URL . @$data->home_bg_s_img2); ?>"
                                                                alt="image2-img">
                                                        </div>
                                                        <div class="tp_upload_pic_thumb">
                                                            <label class="upload_button">
                                                                ...
                                                                <input type="hidden" name="home_bg_s_img2"
                                                                    value="<?php echo e(@$data->home_bg_s_img2); ?>">
                                                ...
                                                <div class="tp_uploade_images_main">
                                                    <div class="tp_upload_area">
                                                        <div class="tp_pic_wrapper tp_img_div tp_img_div home_bg_s_img3">
                                                            <img class="tp_upload_pic"
                                                                src="<?php echo e($STORAGE_URL . @$data->home_bg_s_img3); ?>"
                                                                alt="image3-img">
                                                        </div>
                                                        <div class="tp_upload_pic_thumb">
                                                            <label class="upload_button">
                                                                ...
                                                                <input type="hidden" name="home_bg_s_img3"
                                                                    value="<?php echo e(@$data->home_bg_s_img3); ?>">
                                                ...
                                                <div class="tp_uploade_images_main">
                                                    <div class="tp_upload_area">
                                                        <div class="tp_pic_wrapper tp_img_div home_bg_s_img4">
                                                            <img class="tp_upload_pic"
                                                                src="<?php echo e($STORAGE_URL . @$data->home_bg_s_img4); ?>"
                                                                alt="image4-img">
                                                        </div>
                                                        <div class="tp_upload_pic_thumb">
                                                            <label class="upload_button">
                                                                ...
                                                                <input type="hidden" name="home_bg_s_img4"
                                                                    value="<?php echo e(@$data->home_bg_s_img4); ?>">
                                                ...
                                                <div class="tp_uploade_images_main">
                                                    <div class="tp_upload_area">
                                                        <div class="tp_pic_wrapper tp_img_div login_sign_bg_img">
                                                            <img class="tp_upload_pic"
                                                                src="<?php echo e($STORAGE_URL . @$data->login_sign_bg_img); ?>"
                                                        ...
                                                        <div class="tp_upload_pic_thumb">
                                                            <label class="upload_button">
                                                                ...
                                                                <input type="hidden" name="login_sign_bg_img"
                                                                    value="<?php echo e(@$data->login_sign_bg_img); ?>">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="setting-tab-tar" id="footer-settings">
                        <form id="footer-form" action="<?php echo e(route('admin.setting.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="tp_catset_box tp_footer_setting">
                                ...
                                <div class="tp_form_wrapper tp_label_bold ">
                                    ...
                                    <input class="form-control" type="text" name="copyright_text"
                                        placeholder="Enter Copyright Text" value="<?php echo e(@$data->copyright_text); ?>">
                                </div>
                                <div class="tp_form_wrapper tp_label_bold">
                                    <div class="tp_flex_lable">
                                        ...
                                        <div class="condition-toggle">
                                            <input id="check-active-1" type="checkbox" name="is_checked_facebook"
                                                value="1" <?php echo e(@$data->is_checked_facebook == 1 ? 'checked' : ''); ?>>
                                    ...
                                    <input class="form-control" type="text" name="facebook_url"
                                        placeholder="Enter Facebook URL" value="<?php echo e(@$data->facebook_url); ?>">
                                </div>
                                <div class="tp_form_wrapper tp_label_bold">
                                    <div class="tp_flex_lable">
                                        ...
                                        <div class="condition-toggle">
                                            <input id="check-active-2" type="checkbox" name="is_checked_twitter"
                                                value="1" <?php echo e(@$data->is_checked_twitter == 1 ? 'checked' : ''); ?>>
                                    ...
                                    <input type="text" class="form-control" name="twitter_url"
                                        placeholder="Enter Twitter URL" value="<?php echo e(@$data->twitter_url); ?>">
                                </div>
                                <div class="tp_form_wrapper tp_label_bold">
                                    <div class="tp_flex_lable">
                                        ...
                                        <div class="condition-toggle">
                                            <input id="check-active-3" type="checkbox" name="is_checked_insta"
                                                value="1" <?php echo e(@$data->is_checked_insta == 1 ? 'checked' : ''); ?>>
                                    ...
                                    <input type="text" class="form-control" name="instagram_url"
                                        placeholder="Enter Instagram URL" value="<?php echo e(@$data->instagram_url); ?>">
                                </div>
                                <div class="tp_form_wrapper tp_label_bold">
                                    <div class="tp_flex_lable">
                                        ...
                                        <div class="condition-toggle">
                                            <input id="check-active-4" type="checkbox" name="is_checked_youtube"
                                                value="1" <?php echo e(@$data->is_checked_youtube == 1 ? 'checked' : ''); ?>>
                                    ...
                                    <input type="text" class="form-control" name="youtube_url"
                                        placeholder="Enter Youtube URL" value="<?php echo e(@$data->youtube_url); ?>">
                                </div>
                                <div class="tp_form_wrapper tp_label_bold">
                                    <div class="tp_flex_lable">
                                        ...
                                        <div class="condition-toggle">
                                            <input id="check-active-5" type="checkbox" name="is_checked_footer_text"
                                                value="1" <?php echo e(@$data->is_checked_footer_text == 1 ? 'checked' : ''); ?>>
                                    ...
                                    <input type="text" class="form-control" name="footer_text"
                                        placeholder="Enter Footer Text" value="<?php echo e(@$data->footer_text); ?>">
                                </div>
                                <div class="tp_form_wrapper tp_label_bold">
                                    <div class="tp_flex_lable">
                                        ...
                                        <div class="condition-toggle">
                                            <input id="check-active-newsletter" type="checkbox"
                                                ...
                                                <?php echo e(@$data->is_checked_newsletter == 1 ? 'checked' : ''); ?>>
                                    ...
                                    <input type="text" class="form-control" name="newsletter_text"
                                        placeholder="Enter Newsletters Text" value="<?php echo e(@$data->newsletter_text); ?>">
                                </div>
                                <div class="tp_form_wrapper tp_label_bold">
                                    <div class="tp_flex_lable">
                                        ...
                                        <div class="condition-toggle">
                                            <input id="check-active-address" type="checkbox" name="is_checked_address"
                                                value="1" <?php echo e(@$data->is_checked_address == 1 ? 'checked' : ''); ?>>
                                    ...
                                    <input type="text" class="form-control" name="company_adderss"
                                        placeholder="Enter Address" value="<?php echo e(@$data->company_adderss); ?>">
                                </div>
                                <div class="tp_form_wrapper tp_label_bold">
                                    <div class="tp_flex_lable">
                                        ...
                                        <div class="condition-toggle">
                                            <input id="check-active-phone" type="checkbox" name="is_checked_phone"
                                                value="1" <?php echo e(@$data->is_checked_phone == 1 ? 'checked' : ''); ?>>
                                    ...
                                    <input type="text" class="form-control" name="company_phone"
                                        placeholder="Enter Phone Number" value="<?php echo e(@$data->company_phone); ?>">
                                </div>
                                <div class="tp_form_wrapper tp_label_bold">
                                    <div class="tp_flex_lable">
                                        ...
                                        <div class="condition-toggle">
                                            <input id="check-active-email" type="checkbox" name="is_checked_email"
                                                value="1" <?php echo e(@$data->is_checked_email == 1 ? 'checked' : ''); ?>>
                                    ...
                                    <input class="form-control" type="text" name="company_email"
                                        placeholder="Enter Email" value="<?php echo e(@$data->company_email); ?>">
                                </div>
...
<?php $__env->startSection('scripts'); ?>
    <script src="<?php echo e(asset('admin-theme/my_assets/js/setting.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\newway\resources\views/admin/setting/website.blade.php ENDPATH**/ ?>