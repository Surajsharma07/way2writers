                ...
                <div class="modal-body">
                    <div class="add_user_form">
                        ...
                        <form action="{{ route('admin.email_integrations.store') }}" method="post"
                            ...
                            <div>
                                <div class="form-group">
                                    <label>API Key</label>
                                    <input type="text" class="form-control Mailchimp_cls mb-2" id="Mailchimp_apikey"
                        ...
                        <form action="{{ route('admin.email_integrations.store') }}" method="post"
                            ...
                            <div class="form-group">
                                <label>API Key</label>
                                <input type="text" class="form-control GetResponse_cls mb-2" id="GetResponse_apikey"
                                    name="api_key" placeholder="Enter API Key">
                            </div>
                            <div class="mt-2">
                        ...
                        <form action="{{ route('admin.email_integrations.store') }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-2" name="user_name" placeholder="Enter User Eamil">
                            </div>
                            <div class="form-group">
