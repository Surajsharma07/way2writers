                                ...
                                @if ($data->count() > 0)
                                    @foreach ($data as $key => $item)
                                        <tr id="table_row_{{ $item->id }}">
                                            ...
                                            <td>{{ $item->is_lifetime == 1 ? 'LIFETIME' : set_date_format($item->end_date) }}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="#" class="tp_delete tp_tooltip" title="Delete"  onclick="delete_single_details('{{ route('admin.discount_coupon.destroy', $item->id) }}','{{$item->id}}')">
