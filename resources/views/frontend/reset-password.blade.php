...
<meta property=og:locale content="{{ app() }}" />
        ...
        <div class="tp_login_flex">
            <div class="tp_login_main">
                <div class="tp_login_auth">
                    ...
                    <form id="reset-password-form" action="{{route('frontend.post-reset-password',app())}}" method="post">
                        <div class="tp_login_form">
                           @csrf
                            ...
                            <div class="tp_login_btn">
                                ...
                                <p>@lang('master.reset_password.already_account') <a href="{{ route('frontend.sign-in',app()) }}">@lang('master.reset_password.login')</a></p>
                            </div>
                        </div>
