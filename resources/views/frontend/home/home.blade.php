		...
		<div class="row">
			<section class="col-sm-4">
				<article class="media resume-services">
					<div class="pull-left pos_cnt"><img src="{{ $ASSET_URL }}assets/images/my_images/images/spacer.gif" class="posover icon-stat" /></div>
			...
			<section class="col-sm-4">
				...
				<article class="media resume-services">
					<div class="pull-left pos_cnt"><img src="{{ $ASSET_URL }}assets/images/my_images/images/spacer.gif" class="posover icon-stat icon-31" /></div>
					<div class="media-body pos_cnt">
						<div class="position">
			...
			<section class="col-sm-4">
				<article class="media resume-services">
					<div class="pull-left pos_cnt"><img src="{{ $ASSET_URL }}assets/images/my_images/images/spacer.gif" class="posover icon-stat icon-40" /></div>
					<div class="media-body pos_cnt">
						<div class="position">
...
<div class="nav-box justify-content-center">
    ...
    @foreach ($featured_category as $index => $row)
        <li class="nav-item">
            <a class="nav-link {{ $index === 0 ? 'active' : '' }}" href="javascript:void(0)">{{ $row->name }}</a>
        </li>
    @endforeach
</ul>
</div>
			...
			<section class="content" style="display:block;">
				...
				<article class="content-wrap-block col-sm-12">
					<a class="example-image-link zoomicon" href="{{ $ASSET_URL }}assets/images/my_images/images/sample1/zoom/Infographic Resume.jpg" data-lightbox="example-1" data-title="Infographic Resume">
						<img src="{{ $ASSET_URL }}assets/images/my_images/images/sample1/infographic.jpg" class="mfl-rightnone" alt="author" />
					</a>
			...
			<section class="content">
				...
				<article class="content-wrap-block col-sm-12">                
                   <a class="example-image-link zoomicon" href="{{ $ASSET_URL }}assets/images/my_images/images/sample1/zoom/Visual-Sample.jpg" data-lightbox="example-1" data-title="Visual Resume">
					<img src="{{ $ASSET_URL }}assets/images/my_images/images/sample1/Visual Sample.jpg" class="mfl-rightnone" alt="author" />
                   </a> 
			...
			<section class="content">
				...
				<article class="content-wrap-block col-sm-12">
                   <a class="example-image-link zoomicon" href="{{ $ASSET_URL }}assets/images/my_images/images/sample1/zoom/Textual Sample.jpg" data-lightbox="example-1" data-title="Textual Resume">
					<img src="{{ $ASSET_URL }}assets/images/my_images/images/sample1/textual.jpg" class="mfl-rightnone" alt="author" />
                    </a>
			...
			<section class="content">
				...
				<article class="content-wrap-block col-sm-12">
                  <a class="example-image-link zoomicon" href="{{ $ASSET_URL }}assets/images/my_images/images//zoom/Social Profile.jpg" data-lightbox="example-1" data-title="Social Profile">
					<img src="{{ $ASSET_URL }}assets/images/my_images/images/sample1/Social-Profile.jpg" class="mfl-rightnone" alt="author" />
                  </a>
            ...
            <section class="content">
				...
				<article class="content-wrap-block col-sm-12">
                    <a class="example-image-link zoomicon" href="{{ $ASSET_URL }}assets/images/my_images/images/sample1/zoom/International Resume.jpg" data-lightbox="example-1" data-title="International Resume">
					<img src="{{ $ASSET_URL }}assets/images/my_images/images/sample1/international.jpg" class="mfl-rightnone" alt="author" />
                    </a>
