            ...
            <div class="tp_payment_inner tp_payment_sucess_inner">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12">
                        <div class="tp_payment_info tp_payment_sucess">
                            ...
                            <div class="tp_payment_product">
                                ...
                                {{-- <div class="tp_payproduct_list">
                                    <ul>
                                        @foreach ($fileArr as $key => $value)
                                            <li>
                                                <h5><a href="{{ route('frontend.download-file', [app()->getLocale(),'file_id' => @$value['file_id'], 'tnx_id' => @$tnxId, 'pid' => @$value['product_id']]) }}"
...
href="{{ route('frontend.download-file', ['file_id' => @$value['file_id'], 'tnx_id' => @$tnxId, 'pid' => @$value['product_id']]) }}"
                                                    class=" tp_btn_payment tp_right_space"><span><i class="fa fa-download"
