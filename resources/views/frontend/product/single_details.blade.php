            ...
            <div class="row">
                            ...
                            <div class="tab-pane fade" id="pills-Comments" role="tabpanel"
                                ...
                                <div class="tp_tem_comments">
                                        ...
                                        <form method="POST" id="add-product-comment-form">
                                            ...
                                            <div class="form-outline form-white">
                                                ...
                                                <button class="tp_btn tp_btn_post"
                                                    @if (!Auth::check()) data-bs-toggle="modal" data-bs-target="#log_modal" type="button" @else type="submit" @endif id="add-product-comment-form-btn">@lang('master.single_product.post_comment')</button>
                                            </div>
                                    ...
                                    <div class="text-center mt-2">
                                        <button type="button" class="tp_btn border rounded-pill d-none" id="load_more_cmd_button"
                ...
                <div class="col-xl-4 col-lg-5 col-md-12">
                        ...
                        <div class="tp_leftbar_box">
                            <div class="tp_tem_option">
                                ...
                                <div class="tp_buy_btn">
                                    <a href="javascript:;"
                                        @if (Auth::check()) onclick="addToCart('',1)" @else data-bs-toggle="modal" data-bs-target="#log_modal" @endif
                    ...
                    <div class="tp_leftbar_box">
                        ...
                        <div class="tp_product_theme_flex">
                            <div class="tp_product_theme">
                                <img src="{{ $ASSET_URL }}assets/images/marktify.jpg" alt="Image" />
                            </div>
                            <div class="tp_john_flex">
                                <h5>@lang('master.single_product.theme_portal')</h5>
                                <p>@lang('master.single_product.india')</p>
                            </div>
                        </div>
                    </div>
                </div>
