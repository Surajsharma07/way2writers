      ...
      <div class="row">
        <div class="col-md-6 faq position">
          ...
          <div class="why">
            ...
            <dl>
                          <dt><img src="{{ asset('storage/my_images/images/spacer.gif') }}" class="ico cus-icon cus-prowrt"> Professional Writers</dt>
                          <dd>We have an enlightened team of experts who carry functional area knowledge in your domains.</dd>
                          <dt><img src="{{ asset('storage/my_images/images/spacer.gif') }}" class="ico cus-icon cus-history"> On-time Delivery</dt>
                          <dd>We guarantee 100% on-time delivery of our services within the agreed timeline.</dd>
                          <dt><img src="{{ asset('storage/my_images/images/spacer.gif') }}" class="ico cus-icon cus-offer"> Active Customer Support</dt>
                          <dd>We ensure that you get a resolution within 24 working hours of receiving your query.</dd>
                          <dt><img src="{{ asset('storage/my_images/images/spacer.gif') }}" class="ico cus-icon contact-writer"> Direct Contact with your writer</dt>
          ...
          <div class="d-none d-md-block">
              ...
              <div class="row">
                  <div class="col-sm-4">
                      ...
                      <div class="">
                          <img src="{{ asset('storage/my_images/images/guarantee.png') }}" style="margin-left:10px;height: 100px;margin-top: -20px;" />
                      </div>
                  </div>
                  ...
                  <div class="col-sm-4">
                      ...
                      <div class="row text-center">
                          <img src="{{ asset('storage/my_images/images/instamojo-strip.jpg') }}" style="height: 50px;" />
                      </div>
                  </div>
...
<link href="{{ asset('user-theme/my_assets/extra.css') }}" rel="stylesheet">
