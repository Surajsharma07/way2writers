...
">
                ...
                @if (@$setting->is_check_about)
                    <li @if (Route::is('frontend.about-us')) class="active" @endif><a
                            href="{{ route('frontend.about-us') }}" style="
    color: black;
"> @lang('master.header.About_Us')</a>
                    </li>
                @endif
              ...
              @if (@$setting->is_check_product)
                    <li style="
    color: black;
" @if (Route::is('frontend.product.search')) class="active" @endif>
     ...
     @if (@$setting->is_check_terms_and_condition)
                ...
                @if (@$setting->is_check_contact)
                    <li @if (Route::is('frontend.contact-us')) class="active" @endif>
                        <a style="
    color: black;
" href="{{ route('frontend.contact-us') }}">@lang('master.header.Contact_Us')</a>
                    </li>
                @endif
<li @if (Route::is('frontend.blogs.index')) class="active" @endif>
                        <a style="
    color: black;" href="{{ route('frontend.blogs.index') }}">Blogs</a>
                    </li>
