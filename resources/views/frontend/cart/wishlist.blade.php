                    ...
                    <div class="tp_single_grid product_list_view">
                        @foreach ($wishlist as $key => $item)
                            <div class="tp_istop_box">
                                <a
href="{{ route('frontend.product.single_details', $item->getProduct->slug) }}">
                                    <div class="grid_img">
                                ...
                                <div class="tp_overlay_btn">
                                    <form
action="{{ route('frontend.wishlist.remove', ['id' => $item->id]) }}"
...
href="{{ route('frontend.product.search') }}">@lang('master.cart.add_now')</a></p>
                @endif
            </div>
        </div>
    </div>
