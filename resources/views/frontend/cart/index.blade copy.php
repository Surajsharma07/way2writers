            ...
            <div class="row">
                    ...
                    <div class="tp_view_box">
                        ...
                        @if (Cart::instance('default')->count() > 0)
                            <div class="tp_cart_step">
                                ...
                                <div class="tp_step_box">
                                    <a href="{{ route('frontend.checkout', app()) }}"><svg
                        ...
                        @foreach (Cart::instance('default')->content() as $item)
                            <div class="tp_istop_box">
                                ...
                                <div class="tp_overlay_btn">
                                    <form
                                        action="{{ route('frontend.cart.destroy', [app(), $item->rowId, 'default']) }}"
                    ...
                    <div class="col-lg-12">
                        <div class="tp_view_box tp_concheck_box">
                            ...
                            <div class="tp_continue_checkout">
                                <a @if (Auth::check()) href="{{ route('frontend.checkout', app()) }}" @else data-bs-toggle="modal" data-bs-target="#log_modal" @endif
                ...
                @else
                    <p>@lang('master.cart.no_item_cart') <a
                            href="{{ route('frontend.product.search', app()) }}">@lang('master.cart.add_now')</a></p>
                @endif
            </div>
        </div>
    </div>
