            ...
            <div class="tp_login_main">
                <div class="tp_login_auth">
                    ...
                    <div class="tp_login_form">
                        <form id="registration-form" action="{{ route('frontend.usersignup') }}" method="post">
                            ...
                            <div class="tp_login_btn">
                                ...
                                <p>@lang('master.register.already_have_an_account') <a href="{{ route('frontend.sign-in') }}">@lang('master.register.login')</a></p>
                            </div>
                        </form>
                    </div>
                </div>
